                            ...
                            <div class="block-content bg-black-op-10">            
                                    <div class="row items-push text-center ">
                                        ...
                                        <div class="col-6">                                         
                                                ...
                                                <div class="<?=$class ?>">   <p><?=$document['src']?></p></div>                 
                                        </div>
                                        <div class="col-6">
                        ...
                        <div class="card">
                            <div class="card-body">         
                                ...
                                <div class="row mb-3" >
                                        ...
                                        <div class="col-sm-8 text-secondary">
                                            <p  type="text"  value=""><?php if($review_remark == ''){  echo "NO REMARKS"; } else { echo $review_remark; } ?></p>
                                        </div>
                                </div>    
                                    <div class="row mb-3" >
                                        <div class="col-sm-4">
                                        ...
                                        <div class="col-sm-8 text-secondary">                                  
                                            <p><?php if($approval_remark == ''){  echo "NO REMARKS"; } else { echo $approval_remark; } ?></p>
                                        </div>                        
                                    </div>

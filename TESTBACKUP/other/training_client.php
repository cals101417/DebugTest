...
//                                                $training
                ...
                <div class="bg-gd-sea">
                    <div class="bg-pattern" style="background-image: url('assets/media/photos/construction13.jpg');">
                        <div class="content content-top content-full text-center bg-black-op-75">
                            <div class="py-20">
                                <h1 class="h2 font-w700 text-white mb-10">Client Training</h1>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="content">
                    <h2 class="content-heading">
                        ...
                        ?>
                        <button type="button" class="btn btn-sm btn-rounded btn-success float-right" id="btn_new_training" <?=$add_disable?> onclick = "set_type(2)">Create New Training</button>
                        Client Training
                    </h2>
                    <div class="block">
                        <div class="block-header block-header-default">
                            ...
                            <table id="tbl_training" class="table table-vcenter">
                                ...
                                foreach ($trainings as $training) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <button class="btn btn-sm btn-primary js-tooltip-enabled" onclick="view_training(<?=$training_id?>,'client')" data-toggle="tooltip" title="View Details" data-original-title="View Details">
                                                    <i class="fa fa-eye"></i>
                                                </button>

    ...
    <div id="page-container" class="sidebar-o enable-page-overlay side-scroll <?= $header_layout ?> page-header-inverse <?= $main_content . ' ' . $sidebar_layout ?>">
        ...
        if (isset($_GET['review'])) {
            ...
            WHERE document_id = $document_id ORDER BY document_id DESC");
                ...
                $reviewer_comments_qry = $conn->query("SELECT *                                                
                                                            ...
                                                            WHERE tbl_document_comments_replies.document_id = $document_id  AND tbl_document_comments_replies.is_deleted = 0                                                          
                                                            ORDER BY document_id DESC");
        ...
        ?>
            ...
            <main id="main-container">
                ...
                ?>
                <input type="text" hidden value="<?= $user_id ?>" name="reviewer_name" id="rev_id">
                <input type="text" hidden value="<?= $document['document_id'] ?>" name="document_name" id="document_id">
                <!-- GLOBAL VARIABLE  -->
                <div class="bg-dark">
                    <div class="bg-pattern bg-black-op-25" style="background-image: url('assets/media/photos/construction7.jpg');">
                        <div class="content content-top text-center">
                            <div class="py-50">
                                <h1 class="font-w700 text-white mb-10">Approve/Reject Document</h1>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container shadow p-3 mb-5 bg-white border">
                    <div class="content">
                        ...
                        <!-- DIV BLOCK  -->
                        <div class="block">
                            <div class="block-header block-header-default bg-pattern" style="background-color: #808080">
                                <p class="text-white">Document No. <?= $this_document = $document['document_id'] ?><?php  ?></p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <table class="table table-striped table-bordered table-sm mt-20  text-center">
                                        <thead>
                                            ...
                                            <!--                                        attached file reviewer comment code legend-->
                                        </thead>
                                        <?php $comment_status = ''; ?>
                                        <tbody>
                                            <?php $counter = 1; ?>
                                            <?php foreach ($rev_comments as $rev_comment) : ?>
                                                <?php
                                                if ($rev_comment['reviewer_id'] == $user_id) {
                                                    $comment_status = "B";
                                                }
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        $get_comment_files_qry = $conn->query("SELECT `response_file_src` FROM tbl_document_response_files WHERE response_id = $resp_id AND  response_type = 2");
                                            ...
                                            foreach ($docs2 as $doc2) : ?>
                                                ...
                                                <tr class="text-center" colspan>
                                                    ...
                                                    try {
                                                        ...
                                                        if ($rev_status == "0" ||  $rev_status == "C" || $doc_status != "0") {
                                ...
                                <div class="col-sm-12">
                                    <table class="table table-bordered" id="action_table">
                                        <thead>
                                            <th class="text-center" colspan="3">Document Approval Action</th>
                                        </thead>
                                        <tbody>
                                            <!--                                            for testing-->
                                            <?php
                        ...
                        <div class="modal-content">
                            ...
                            <form id="review_action">
                                <div class="modal-body">
                                    ...
                                    <input hidden type="text" value="2" name="actor_type" id="actor_type">
                                    ...
                                    <input hidden type="text" value="<?= $user_id ?>" name="rev_id" id="rev_id">
                                    ...
                                    <br>
                                    <?php
                                    $user_sql = $conn->query("SELECT `user_id`, `firstname`, `lastname`,`email`
                                ...
                                <div class="modal-footer">
                                    <div class="col-sm-12 text-center">
                                        <button type="submit" class="btn btn-success action_rev" id="approve_document"> Submit Action </button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form id="edit_comment_action">
                                <div class="modal-body">
                                    ...
                                    <input hidden type="text" value="<?= $user_id ?>" name="reviewer_id">
                                    <input hidden type="text" value="" name="edit_response_id" id="edit_response_id">
                                    <!-- HIDDEN VARIABLES     -->
                                    <div class="form-group row" id="comment div">
                                        <label class="col-sm-3" for="comment_code" id="comment_label">Comment Code: </label>
                                        <div class="col-sm-9" id="comment_div">
                                            <select class="form-control" name="edit_comment_code" id="edit_comment_code" aria-label=".form-select-lg example">
                                                <option value="1">1</option>
                                                <option value="2">2</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row" id=" div">
                                        <label class="col-sm-3" for="reply" id="comment_label">Comment: </label>
                                        <div class="col-sm-9" id="reply_div">
                                            <input class="form-control form-control-lg text-sm-left" type="text" id="edit_comment" name="edit_comment">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-3" for="reply" id="comment_label">Page/Section: </label>
                                        <div class="col-sm-9" id="reply_div">
                            ...
                            <form id="comment_action">
                                <div class="modal-body">
                                    ...
                                    <div class="form-group row" id="comment div">
                                        <label class="col-sm-3" for="comment_code" id="comment_label">Comment Code: </label>
                                        <div class="col-sm-9" id="comment_div">
                                            <select class="form-control" name="comment_code" id="comment_code" aria-label=".form-select-lg example">
                                                <option value="1">1</option>
                                                <option value="2">2</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row" id=" div">
                                        <label class="col-sm-3" for="reply" id="comment_label">Comment: </label>
                                        <div class="col-sm-9" id="reply_div">
                                            <input class="form-control form-control-lg text-sm-left" type="text" id="reply" name="reviewer_comment">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-3" for="reply" id="comment_label">Page/Section: </label>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-3" for="reply" id="comment_label">Revised file: </label>
                                        <div class="col-sm-9" id="reply_div">
                                            <input class="form-control form-control-lg text-sm-left" multiple type="file" id="revised_files" name="revised_files[]">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-3" for="select_approval">Add CC</label>
...
<script>
    $(document).ready(function() {
        //var documents  = <?php //echo json_encode($document)
                            ?>//;
        //const myJSON = JSON.stringify(documents);
        //x = "sdad";
        ...
        //$('#action_table').attr("hidden", <?php //echo $action_table
                                            ?>//);
    });
</script>

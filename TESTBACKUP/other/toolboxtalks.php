                                        ...
                                        <td>
                                            <div class="input-group" >
                                                <div class="input-group-append">
                                                    <input class="form-control form-control-sm w-25" <?=$set_input?> type="number" id="add_time<?=$tbtp_id?>" value="<?=$time?>">                                             
                                                    <button class="btn btn-sm btn-success" <?=$set_time_btn_status ?> onclick="set_time(<?=$tbtp_id?>)">Set</button>
                                                </div>
                                            </div>
                                        </td>
            ...
            <div class="bg-gd-lake">
                <div class="bg-pattern" style="background-image: url('assets/media/various/bg-pattern.png');">
                    <div class="content content-top content-full text-center">
                        <div class="py-20">
                            <h1 class="h2 font-w700 text-white mb-10">Toolbox Talks - Civil</h1>
                        </div>
                    </div>
                </div>
            </div>
